...
async takeMedicines(){
    ...
    if(flag==0){
        ...
        dbref.on("value", (snapshot)=>{
            ...
            medicines = tempVar;
            console.log("emergency numbers", medicines)
    ...
    render(){
        return(
            <Container ContainerStyle={{flex:1, backgroundColor:'#fff'}}>
                ...
                <Container ContainerStyle={{width:180,alignItems:'center',justifyContent:'center',marginTop:20,height:60, borderColor:'#707070', borderWidth:0.5,alignSelf:'center'}}>
                            <Button onPress={()=>{this.onAddPrescription()}} title="Add Prescription" textStyle={{fontSize:18, color:'black',justifyContent:'center'}} style={{alignItems:'center',flexDirection:'row'}}>
                                <Icon name="md-add" style={{fontSize:20,alignSelf:'center',marginRight:5}}/>
                            </Button>
                        </Container>
