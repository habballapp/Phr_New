            ...
            <Container ContainerStyle={{
                ...
                <SafeViewArea style={{ flex: 1 }}>
                    ...
                    <Scrollview >
                        ...
                        <Container ContainerStyle={styles.formContainer, { alignItems: 'center', justifyContent: 'center', width: '75%' }}>


                            <Container ContainerStyle={{ marginTop: 50, flexDirection: 'row', alignItems: 'center', width: '90%' }}>
                                <Textview textStyle={{ width: '50%', fontSize: 18, fontWeight: 'bold', color: '#0000FF' }}>
                                    Provider Type:
                            </Textview>
                                <Input
                                    placeholder=""
                            ...
                            <Container ContainerStyle={{ flexDirection: 'row', alignItems: 'center', width: '90%'}}>
                                <Textview textStyle={{ width: '45%', fontSize: 18, fontWeight: 'bold', color: '#0000FF' }}>
                                    Prescription:
                            </Textview>
                                <Input
                                    placeholder=""
                                    placeholderTextColor="#000"
                                    returnKeyType={"next"}
                                    inputStyle={style.input_personal_details1}
                        ...
                        <Button
                            ...
                            title="Add Provider" style={style.loginButtonStyles1} textStyle={styles.insuranceButtonText} >
                            <FontAwesome
                                name="plus-square-o"
                                size={15}
                                color="white"
